...
namespace Core.Models.Config
{
    ...
    public class GeneralModel
    {
        ...
        [Config(Options = "自动|中|英",Name = "语言",Description = "设置程序首选的显示语言",Group = "界面",CultureCode = CultureCode.ZhCn)]
        [Config(Options = "Auto|Chinese|English", Name = "Language",Description = "Set the preferred display language for the program", Group = "Interface", CultureCode = CultureCode.EnUs)]
