...
public class GeneralModel
{
    ...
    [Config(Name = "StartAtBoot", Description = "Automatically run Taix when the computer starts", Group = "Basics",
        ToggleFalseText = "Off", ToggleTrueText = "On", CultureCode = CultureCode.EnUs)]
    /// <summary>
    /// 是否启用开机自启动
    /// </summary>
    ...
    [Config(Name = "Save Window Size",
        Description = "Retain the current window size instead of using the system default dimensions",
        ToggleFalseText = "Off", ToggleTrueText = "On", Group = "Interface", CultureCode = CultureCode.EnUs)]
    ...
    [Config(Name = "This option is invalid when starting automatically at boot",
        Description = "Show Main Window at Startup", Group = "Basics", ToggleFalseText = "Off", ToggleTrueText = "On",
        CultureCode = CultureCode.EnUs)]
    /// <summary>
    /// 启动软件时显示主界面
    /// </summary>
