...
namespace Taix.Client.Controls.List;
...
public class BaseList : TemplatedControl
{
    ...
    private readonly List<BaseListItem> ItemsMap;
    ...
    {
        get => _items;
        set => SetAndRaise(ItemsProperty, ref _items, value ?? new ObservableCollection<string>());
    }
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            var (oldVal, newVal) = change.GetOldAndNewValue<ObservableCollection<string>>();
            if (oldVal != null) oldVal.CollectionChanged -= Items_CollectionChanged;
    ...
    private void Items_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        if (e.Action == NotifyCollectionChangedAction.Reset) UnsubscribeEvents();
    }
    ...
    private void RemoveItem(string item)
    {
        ...
        if (control != null) Container.Children.Remove(control);
    }
    ...
    {
        foreach (var item in ItemsMap) item.IsSelected = false;
    }
