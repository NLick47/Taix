...
public class Charts : TemplatedControl
{
    ...
    private void RenderColumnStyle()
    {
        ...
        for (var i = 0; i < columns; i++)
        {
            ...
            colNameText.Foreground = Client.Base.Color.Colors.GetFromString("#FF8A8A8A");
            ...
            for (var di = 0; di < columnCount; di++)
            {
                ...
                if (value > 0)
                {
                    ...
                    colValueRect.Fill = Client.Base.Color.Colors.GetFromString(colColor);
                    if (!IsStack)
                    {
        ...
        {
            Stroke = Client.Base.Color.Colors.GetFromString("#ccc"),
            StrokeDashArray = [2, 5],
            StrokeThickness = 1,
        ...
        {
            Stroke = Client.Base.Color.Colors.GetFromString(StateData.ThemeColor),
            StrokeDashArray = [2, 5],
            StrokeThickness = 1
        };
